...
class Promo(Base):
    ...
    discount_rub: Mapped[int] = mapped_column(Integer, nullable=False, server_default='0')
    max_uses: Mapped[int] = mapped_column(Integer, nullable=False, server_default='0')
...
class PromoRedemption(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    promo_id: Mapped[int] = mapped_column(ForeignKey('promos.id', ondelete='CASCADE'), nullable=False)
    user_id: Mapped[int] = mapped_column(ForeignKey('users.id', ondelete='CASCADE'), nullable=False)
    order_id: Mapped[int | None] = mapped_column(ForeignKey('orders.id', ondelete='SET NULL'), nullable=True)
